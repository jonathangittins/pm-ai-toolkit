...
After the kickoff doc is approved, check your initiatives board and ask whether the initiative should move from Next to Now (or whatever your board's "active" column is).
